...
<head>
    <meta charset="UTF-8">
    <title>Ajouter une Ressource | ConstructionXpert</title>
...
<div class="container">
    <div class="page-title text-center mb-4">
        <h3><i class="fas fa-plus-circle me-2"></i> Ajouter une Nouvelle Ressource</h3>
    </div>
        ...
        <div class="col-lg-8">
            <div class="form-container">
                <form action="ressource" method="post">
                    ...
                    <div class="mb-4">
                        <label for="nom" class="form-label required-field">Nom de la Ressource</label>
                        <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrez le nom de la ressource" required>
                    </div>

                    <div class="mb-4">
                        <label for="type" class="form-label required-field">Type</label>
                        <input type="text" class="form-control" id="type" name="type" placeholder="Entrez le type de ressource" required>
                    </div>

                    <div class="mb-4">
                        <label for="quantite" class="form-label required-field">Quantité</label>
                        <input type="number" class="form-control" id="quantite" name="quantite" placeholder="Entrez la quantité disponible" required>
                    </div>

                    <div class="d-flex justify-content-end gap-3 mt-4">
                        <a href="ressource?action=afficher" class="btn btn-secondary cancel-btn">
